...
df = pd.read_csv("data/barodahomeprices2.csv")
# print(df)
# print(df.shape)
...
X = df_dumies[["area", "bedrooms", "year", "Bhayli", "Karelibaug"]]
y = df_dumies["price"]
...
year = int(input("Enter House Age (years): "))
...
prediction = model.predict([[area, bedrooms, year, B, K]])
